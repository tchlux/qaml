...
if __name__ == "__main__":
    ...
    if DEMONSTRATE_INT_ADD:
        ...
        for b in range(1,7):
            ...
            print(b, sol == int_add_table(n_bits=b, signed=False, extra=False))


    DEMONSTRATE_INT_CARRY_ADD = True
    if DEMONSTRATE_INT_CARRY_ADD:
        ...
        from truth import int_add_table
        for b in range(1,7):
            q = int_add_carry(*list(range(1,b*3+1+1)))
            sol = run_qubo(**q, display=False)
